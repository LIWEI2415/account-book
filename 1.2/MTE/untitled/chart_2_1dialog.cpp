...
chart_2_1Dialog::chart_2_1Dialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::chart_2_1Dialog)
{
    ui->setupUi(this);
    //执行相关sql语句
    QSqlQuery sql_query;
    ...
    fossil->setName("月支出");
    fossil->setPen(QPen(QColor(85,255,255).lighter(170)));
    fossil->setBrush(QColor(85,255,255));
    ...
    customPlot->yAxis->setLabel("本年支出");
...
chart_2_1Dialog::~chart_2_1Dialog()
{
    delete ui;
}
